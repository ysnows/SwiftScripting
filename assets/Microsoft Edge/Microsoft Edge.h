...
@class MicrosoftEdgeApplication, MicrosoftEdgeWindow, MicrosoftEdgeTab, MicrosoftEdgeBookmarkFolder, MicrosoftEdgeBookmarkItem;

@protocol Microsoft EdgeGenericMethods
...
@interface MicrosoftEdgeApplication : SBApplication

- (SBElementArray<MicrosoftEdgeWindow *> *) windows;
...
// A window.
@interface MicrosoftEdgeWindow : SBObject <Microsoft EdgeGenericMethods>

- (SBElementArray<MicrosoftEdgeTab *> *) tabs;
...
@property (copy, readonly) MicrosoftEdgeTab *activeTab;  // Returns the currently selected tab
...
// The application's top-level scripting object.
@interface MicrosoftEdgeApplication (ChromiumSuite)

- (SBElementArray<MicrosoftEdgeBookmarkFolder *> *) bookmarkFolders;

@property (copy, readonly) MicrosoftEdgeBookmarkFolder *bookmarksBar;  // The bookmarks bar bookmark folder.
@property (copy, readonly) MicrosoftEdgeBookmarkFolder *otherBookmarks;  // The other bookmarks bookmark folder.

@end

// A tab.
@interface MicrosoftEdgeTab : SBObject <Microsoft EdgeGenericMethods>
...
@interface MicrosoftEdgeBookmarkFolder : SBObject <Microsoft EdgeGenericMethods>

- (SBElementArray<MicrosoftEdgeBookmarkFolder *> *) bookmarkFolders;
- (SBElementArray<MicrosoftEdgeBookmarkItem *> *) bookmarkItems;
...
@interface MicrosoftEdgeBookmarkItem : SBObject <Microsoft EdgeGenericMethods>
