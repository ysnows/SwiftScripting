...
@protocol FirefoxGenericMethods
...
// A scriptable object.
@interface FirefoxItem : SBObject <FirefoxGenericMethods>
...
- (SBElementArray<FirefoxDocument *> *) documents;
- (SBElementArray<FirefoxWindow *> *) windows;
...
- (SBElementArray<FirefoxAttachment *> *) attachments;
- (SBElementArray<FirefoxAttributeRun *> *) attributeRuns;
- (SBElementArray<FirefoxCharacter *> *) characters;
- (SBElementArray<FirefoxParagraph *> *) paragraphs;
- (SBElementArray<FirefoxWord *> *) words;
...
@interface FirefoxPrintSettings : SBObject <FirefoxGenericMethods>
